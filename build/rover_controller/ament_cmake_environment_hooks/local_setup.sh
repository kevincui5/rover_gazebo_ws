...
: ${AMENT_CURRENT_PREFIX:="/home/kevin/rover_gazebo_ws/install/rover_controller"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rover_controller/environment/pythonpath.sh"
