...
: ${AMENT_CURRENT_PREFIX:="/home/kevin/rover_gazebo_ws/install/rover_localization"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rover_localization/environment/pythonpath.sh"
